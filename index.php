				...
				<ul class=" row marketing-list">
					...
					<li class="col-md-4 bg-f9f9f9 p-3">
                        <div class="inner text-center">
                            ...
                            <p>Web Hosting services vary from trades to trades as per the necessity and requirement of variouscompanies. We are providing different types of web hosting plans
						</p>
                            <a href="#" class="know-more">Know More</a>
						</div>
                    </li> 
