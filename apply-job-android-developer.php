...
<div class="container">
	<div class="row">
        ...
        <div class="call-action-bar bg ">
                <div class="container">
                    <h4><span>Interested candidates can forward their resume to <span class="text-warning"><strong>hr@prachatech.com</strong></span></span></h4>
                </div>
            </div>
<!-- ==============================================
**Job Apply**
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <textarea placeholder="" class="large"></textarea>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 text-center ">
                                <button class="btn  btn-sm text-center">Submit </button>
                            </div>
                        </div>
                    </form>
                </div>
