                    ...
                    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                        <ul class="navbar-nav " style="width:100%">
							 ...
							 <li class="nav-item dropdown"> 
                                <a href="index.php" class="nav-link" id="dropdown1"  aria-expanded="false">Home</a>
                            </li>	
							<li class="nav-item dropdown"> 
                                <a href="about.php" class="nav-link" id="dropdown1"  aria-expanded="false">About Us</a>
                            </li>
						
							    <li class="nav-item dropdown"> 
                                <a href="services.php" class="nav-link dropdown-toggle" id="dropdown1"  aria-haspopup="true" aria-expanded="false">Services</a>
                           	...
                           	<li class="nav-item dropdown"> 
                                <a href="portfolio.php" class="nav-link" id="dropdown1"  aria-expanded="false">Portfolio</a>
                            </li>
								
							<li class="nav-item dropdown"> 
                                <a href="career.php" class="nav-link" id="dropdown1"  aria-expanded="false">Careers</a>
                            </li>
							<li class="nav-item dropdown"> 
                                <a href="blog.php" class="nav-link" id="dropdown1"  aria-expanded="false">Blog</a>
                            </li>
							<li class="nav-item dropdown"> 
                                <a href="contact.php" class="nav-link" id="dropdown1"  aria-expanded="false">Contact Us</a>
                            </li>
                        </ul>
